...
from training_pirl_Town2_torch import Env, convection_model, diffusion_model, sample_for_pinn
...
def load_agent(env):
    ...
    #agent.load_weights('logs/Town2/04291642', ckpt_idx= 40_000) # ITSC2024
    agent.load_weights('logs/Town2/05011725', ckpt_idx=30_000) 
